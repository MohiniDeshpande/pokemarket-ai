 ...
 */
export declare const JSON_RPC_ERROR_CODE_PROCESSING_REQUEST_FAILED = -32000;
/**
 * Returned when a request that requires an existing session is received
 * without an `Mcp-Session-Id` header. HTTP status: 400.
 */
export declare const JSON_RPC_ERROR_CODE_SESSION_ID_REQUIRED = -32001;
/**
 ...
 */
export declare const JSON_RPC_ERROR_CODE_SESSION_ID_INVALID = -32002;
/**
 ...
 */
export declare const JSON_RPC_ERROR_CODE_SESSION_NOT_FOUND = -32003;
/**
 ...
 */
export declare const JSON_RPC_ERROR_CODE_INVALID_REQUEST = -32004;
/**
 ...
 * status: 400.
 */
export declare const JSON_RPC_ERROR_CODE_DISALLOWED_EXTERNAL_SESSION = -32005;
//# sourceMappingURL=jsonRpcErrorCodes.d.ts.map