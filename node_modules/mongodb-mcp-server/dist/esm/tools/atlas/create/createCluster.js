...
export const CreateClusterArgsShape = {
    projectId: AtlasArgs.projectId().describe("Atlas project ID to create the cluster in. Use the atlas-list-projects to find project IDs if not provided."),
    ...
    region: AtlasArgs.region().describe("Cloud provider region in Atlas format using uppercase letters and underscores (e.g. US_EAST_1)."),
    clusterType: z
...
export class CreateClusterTool extends AtlasToolBase {
    constructor() {
        ...
        this.argsShape = CreateClusterArgsShape;
    }
    async execute(args) {
