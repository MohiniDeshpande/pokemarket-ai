...
export class ApiClient {
    ...
    constructor(options, logger, authProvider) {
        ...
        this.client = createClient({
            ...
            Request: (isNodeRuntime() ? NodeFetchRequest : globalThis.Request),
        });
    ...
    async upgradeTenantUpgrade(options) {
        const { data, error, response } = await this.client.POST("/api/atlas/v2/groups/{groupId}/clusters/tenantUpgrade", { ...options, headers: { Accept: "application/vnd.atlas.2023-01-01+json", ...options?.headers } });
        if (error) {
            throw ApiClientError.fromError(response, error);
        }
        return data;
    ...
    async tenantUpgrade(options) {
        const { data, error, response } = await this.client.POST("/api/atlas/v2/groups/{groupId}/flexClusters:tenantUpgrade", options);
        if (error) {
            throw ApiClientError.fromError(response, error);
        }
        return data;
