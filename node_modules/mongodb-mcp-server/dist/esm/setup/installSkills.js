...
export const NO_SKILLS_MESSAGE = `We're unable to install the MongoDB Agent Skills for this tool.\n` +
    `\n` +
 ...
 */
export function buildSkillsAddArgs(agentId) {
...
function printInstallFailure(exitCode, args) {
    console.log("");
    console.log(chalk.red(`Agent skills install failed (exit ${exitCode}). Setup completed, but skills were not installed. See the CLI output above for details.`));
    console.log("");
 ...
 */
export async function promptAndInstallSkills(opts) {
    try {
