 ...
 */
export type SetupStage = "started" | "prerequisites_checked" | "ai_tool_selected" | "read_only_selected" | "connection_string_entered" | "service_account_id_entered" | "service_account_secret_entered" | "credentials_validated" | "editor_configured" | "skills_install_prompted" | "open_config_prompted" | "completed" | "cancelled" | "failed";
/**
 ...
 */
export type TelemetryToolMetadata = AtlasMetadata | ConnectionMetadata | PerfAdvisorToolMetadata | StreamsToolMetadata | UpgradeClusterMetadata | CreateClusterMetadata;
...
export declare const SHARED_TIER_METRIC_NAMES: readonly ["CONNECTIONS_PERCENT", "FLEX_CONNECTIONS_PERCENT", "FLEX_DATA_SIZE_TOTAL", "LOGICAL_SIZE"];
