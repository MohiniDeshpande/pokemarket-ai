...
const installSkills_js_1 = require("./installSkills.js");
...
const formatSkillsResult = (result) => {
    switch (result.status) {
        case "installed":
            return chalk_1.default.green("✓ Agent skills installed.");
        case "skipped":
            return chalk_1.default.dim("○ Agent skills skipped.");
        case "failed":
            return chalk_1.default.red(`✗ Agent skills install failed (exit ${result.exitCode}).`);
    }
};
...
const runSetup = async (config) => {
    ...
    try {
        ...
        const skillsResult = await (0, installSkills_js_1.promptAndInstallSkills)({ tool, cwd: process.cwd() });
