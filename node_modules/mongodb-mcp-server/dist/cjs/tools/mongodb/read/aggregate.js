...
exports.AggregateTool = exports.AggregateArgs = exports.pipelineDescriptionWithVectorSearch = void 0;
...
exports.AggregateArgs = {
    pipeline: zod_1.z.array(zod_1.z.union([mongodbSchemas_js_1.VectorSearchStage, mongodbSchemas_js_1.AnyAggregateStage])).describe(exports.pipelineDescriptionWithVectorSearch),
};
            ...
            if (await this.session.isSearchSupported()) {
                ...
                try {
                    ...
                    this.session.logger.debug({
                        id: index_js_1.LogId.mongodbGetSearchIndexesFailure,
